...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary:
        "bg-sky-600 hover:bg-sky-700 text-white shadow-sm hover:shadow focus:ring-sky-500",
      secondary:
        "bg-slate-900 hover:bg-slate-800 text-white shadow-sm hover:shadow focus:ring-slate-700",
      amber:
        "bg-amber-600 hover:bg-amber-700 text-white shadow-sm hover:shadow focus:ring-amber-500",
      outline:
        "border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 hover:text-slate-900 focus:ring-sky-500",
      ghost:
